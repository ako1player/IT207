...
<head>
	...
	<title>Add Comments to Database</title>
...
<body>
	...
	<div id="labcontent">
		...
		<h1>Add Comments to Database</h1>
		<form id="index" action="commentsaddeddb.php" method="post">
		...
		<a href="index.php"><b>Add Comments to text file</b></a>
	</div>	
	<div id="copyright">
